// Dispatch 23: matmul [6144, 1024] @ [1024, 1] -> [6144, 1]  (f16)
...
//   binding(0) ReadOnly|Indirect: weight [6144x1024xf16] at fixed offset 12582912
//                                 input  [1024x1xf16]    at push_const[0]
//   binding(1) Indirect:          output [6144x1xf16]    at push_const[1]
//
// Grid: (N/8, 1, 1) = (768, 1, 1),  Block: (256, 1, 1)
...
void decode_dispatch_23_matmul_6144x1x1024_f16(
    ...
    // Offsets
    const __half* weight = (const __half*)(binding0 + 12582912);
